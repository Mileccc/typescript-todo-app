...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"src/services/taskService.ts":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          newTask = {
            id: new Date().getTime(),
            // Un simple generador de ID
            title: title,
            completed: false
          }; // Realiza una solicitud POST a la API para agregar la nueva tarea.
          _context.next = 3;
          return axios_1.default.post("".concat(API_URL, "/task"), newTask);
        case 3:
        case "end":
  ...
  return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return axios_1.default.get("".concat(API_URL, "/tasks"));
        case 2:
  ...
  return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return axios_1.default.delete("".concat(API_URL, "/task/").concat(taskId));
        case 2:
        case "end":
...
document.getElementById('addTask').addEventListener('click', function () {
  ...
  (0, taskService_1.addTask)(taskInput.value);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, taskService_1.getTasks)();
        case 3:
          tasks = _context.sent;
          // Obtiene el elemento con el id 'taskList' donde se mostrarán las tareas.
          taskList = document.getElementById('taskList'); // Limpia el contenido actual de la lista de tareas en la interfaz.
          taskList.innerHTML = '';
          ...
          tasks.forEach(function (task) {
            ...
            deleteButton.addEventListener('click', function () {
              ...
              (0, taskService_1.deleteTask)(task.id);
        ...
        case 9:
          ...
          console.error('Error al obtener las tareas:', _context.t0);
        case 12:
        case "end":
          return _context.stop();
      }
...
renderTasks();
},{"./services/taskService":"src/services/taskService.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
